...
// 正式
// export const GetArticleShow = () => ajax(BASE_URL + '/Article/GetArticleShow?Keyword=&ClassifyID=44&Pagesize=15&Pageindex=1&IsRecommend=0')
// 获取文章详情有权限
...
// 增加直播记录
export const UpdateStudyCourseProgress = (params) => ajax(BASE_URL + '/Course/UpdateStudyCourseProgress', params)
// 获取课程评论
